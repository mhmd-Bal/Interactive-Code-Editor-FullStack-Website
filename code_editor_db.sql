...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2023 at 07:59 PM
...
(5, '2023_03_24_184501_create_codes_table', 1),
(6, '2023_03_24_184846_create_chats_table', 1),
(7, '2023_03_24_185312_create_favorites_table', 1);
...
ALTER TABLE `favorites`
  ...
  ADD KEY `favorites_code_id_foreign` (`code_id`);
...
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_code_id_foreign` FOREIGN KEY (`code_id`) REFERENCES `codes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
